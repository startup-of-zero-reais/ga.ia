...
export default function CreateWorkspaceForm() {
	...
	const { data, isLoading: searching } = useSWR(
		slug ? `${API_DOMAIN}/v1/workspaces/${slug}` : null,
		fetcherWithCookies,
	...
	return (
		<form className="w-full flex flex-col gap-4" onSubmit={onSubmit}>
			<div>
				<Label htmlFor="name">Escolha um nome para seu Workspace</Label>
				<div
					className={cn(
						'grid transition-all',
			...
			<div>
				<Label htmlFor="description">Descrição do workspace</Label>
				<Textarea
					id="description"
					placeholder="Workspace para gestão do meu negócio"
					name="description"
				/>
